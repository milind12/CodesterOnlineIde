<%--
    Document   : OneTimeP
    Created on : 9 Mar, 2017, 2:52:41 AM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <title>Codester |One Time Password</title>
        <meta charset="utf-8">
  ...
  <![endif]-->
    ...
    <body>
        ...
        <h3 style="margin-bottom:4%;margin-left: 40% ">OneTimePassword</h3>
                    ...
                    <div class="" >
                        <div >
                            <div class="container clearfix">
                                ...
                                <form class="form-horizontal" action="OneTimePServlet" method="post" >
                                    ...
                                    <table>
                                        ...
                                        <tr><td>
                                            ...
                                            <td></td><td>       <div class="control-group">
                                                    <div class="controls">
                                                        <button type="submit" class="btn btn-1 input-large">Update Password</button>
                                                    </div></td></tr></table>
