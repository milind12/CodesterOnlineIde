<%--
    ...
    Created on : Apr 6, 2017, 3:01:18 PM
    Author     : Milind Ghiya
--%>
...
<html lang="en">
  ...
  <![endif]-->
        ...
        <div class="offset6 span10 " style="margin-top: 2%" >
            ...
            <table>
                <tr class="tr1"><td> Codester:</td><td style="padding-left: 20px;font-size: 1.2em"><strong>${otheruser.name}</strong></td></tr>
            <tr class="tr1"> <td>Username:</td><td style="padding-left: 20px;font-size: 1.2em"><strong> ${otheruser.username}</strong></td></tr>
            <tr class="tr1">    <td>Email:</td><td style="padding-left: 20px;font-size: 1.2em"> <strong>${otheruser.email}</strong></td></tr>
            <tr class="tr1"> <td>College:</td><td style="padding-left: 20px;font-size: 1.2em"><strong>${otheruser.college}</strong></td></tr>
        </table>
    </div>
