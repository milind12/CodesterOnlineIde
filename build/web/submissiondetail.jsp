<%--
    ...
    Created on : Apr 6, 2017, 2:12:18 PM
    Author     : Milind Ghiya
--%>
...
<html lang="en">
  ...
  <![endif]-->
    ...
    <body >
        ...
        <d:SubmissionDetails></d:SubmissionDetails>
            ...
            <div>
                <a href='contestresults.jsp?contestid=${contest.contestId}' style='color:#F25C27'><i class="icon-arrow-left"></i> Back to Results</a>
            </div>
            <strong>   <font style="color:#0044cc" >    ${param.username}'s submissions</font></strong>
            ...
            <div style="margin-top:20px">
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${subs}" var="current" varStatus="o">
                        <tr>
                            <td>${o.count}</td>
                            <td>${current.score}</td>
                            <td>${current.result}</td>
                            <td>${current.ip}</td>
                            <td>${current.formattedStime}</td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
