<%-- 
    Document   : signup2
    Created on : Jan 17, 2017, 9:32:50 PM
    Author     : Milind Ghiya
--%>
...
<div class="container clearfix">
    ...
    <form class="form-horizontal" action="SignUpServlet" >
  <h5 align="center">${sessionScope.message}</h5>
    ...
    <div class="controls">
      <input type="text" name="collegename" id="collegename" placeholder="College Name">
    </div>
  </div>
       <div class="control-group">
    <strong style="color:whitesmoke"><label class="control-label" for="inputEmail">College Address</label></strong>
    <div class="controls">
      <input type="text" name="collegeaddress" id="collegeaddress" placeholder="College Address">
    </div>
  </div>
<div class="control-group">
    <strong style="color:whitesmoke"><label class="control-label" for="inputEmail">Contest Host name</label></strong>
    <div class="controls">
      <input type="text" name="name" id="name" placeholder="Contest Host">
    </div>
  </div>
            <div class="control-group">
    ...
    <div class="controls">
      <input type="text" name="username" id="username" placeholder="Username">
            ...
            <div class="control-group">
       <strong style="color:whitesmoke"> <label class="control-label" for="inputPassword">Phone no.</label></strong>
    <div class="controls">
      <input type="text" name="phone" id="phone" placeholder="Phone no.">
    </div>
  </div>
<div class="control-group">
    <strong style="color:whitesmoke"><label class="control-label" for="inputcol">Email</label></strong>
    <div class="controls">
...
<%--<div class="control-group">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="password" name="confirmpassword" id="inputPassword2" placeholder="Confirm Password">
    </div>
  </div>
  --%>
